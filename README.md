...
Проект T-Bank Junior Java — это Java-приложение, использующее Spring Boot и Liquibase для управления схемой базы данных. В этом руководстве описано, как запустить проект локально и с использованием Docker.
...
1. **Настройте файл окружения**
   ...
   Создайте файл `.env` в корневой директории проекта, если его еще нет, и добавьте ваш API ключ и другие необходимые переменные окружения. Например:
